...
const char* ssid = "Familia_Coy"; //estoy en la red del trabajo cambiar.
const char* password = "9876543210"; //estoy en la red del trabajo cambiar.
const char* serverUrl = "http://192.168.100.22:3001/datos"; // Cambia 'tu_servidor' por la dirección IP o dominio de tu servidor
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (receivedChar == 'v' || receivedChar == 'V') {
      ...
      doc["nombrecompleto"] = "sebastian garcia";
      doc["correouniversidad"] = "mgarciac82@miumg.edu.gt";
      doc["carne"] = "0902-21-415";
